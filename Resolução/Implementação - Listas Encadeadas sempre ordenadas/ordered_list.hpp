class ordered_list {
    private:
        ...
        public:
            ...
            // referência para o nó que vem antes do atual
            no_encadeado* anterior;
        ...
        // Referência para o primeiro nó encadeado da lista
        no_encadeado* primeiro;
        // Referência para o último nó encadeado da Lista.
        no_encadeado* ultimo;
